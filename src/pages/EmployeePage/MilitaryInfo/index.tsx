...
import { useDeleteEmployeeMilitaryInfo, useGetEmployeeMilitaryInfo } from 'src/api';
...
const MilitaryInfo = () => {
  ...
  const { data = [] as IMilitaryInfo[], isLoading } = useGetEmployeeMilitaryInfo();
  const { mutate, isPending } = useDeleteEmployeeMilitaryInfo();
  ...
  return (
    <Stack width="100%" height="100%">
      ...
      >
        Bu əməliyyat daimidir və geri qaytarıla bilməz. Hərbi məlumatları silmək istədiyinizə əminsiniz?
      </ConfirmModal>
    </Stack>
  );
};
