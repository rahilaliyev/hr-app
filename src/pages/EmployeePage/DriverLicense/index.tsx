...
import { useDeleteEmployeeDriverLicense, useGetEmployeeDriverLicenses } from 'src/api';
...
const DriverLicense = () => {
  ...
  const { data = [] as IDriverLicense[], isLoading } = useGetEmployeeDriverLicenses();
  const { mutate, isPending } = useDeleteEmployeeDriverLicense();
  ...
  return (
    <Stack width="100%" height="100%">
      ...
      >
        Bu əməliyyat daimidir və geri qaytarıla bilməz. İşçinin sürücülük vəsiqəsi ilə bağlı məlumatını silmək
