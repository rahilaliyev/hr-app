...
import { useDeleteEmployeeMedicalInfo, useGetEmployeeMedicalInfo } from 'src/api';
...
const MedicalInfo = () => {
  ...
  const { data = [] as IMedicalInfo[], isLoading } = useGetEmployeeMedicalInfo();
  const { mutate, isPending } = useDeleteEmployeeMedicalInfo();
  ...
  return (
    <Stack width="100%" height="100%">
      ...
      >
        Bu əməliyyat daimidir və geri qaytarıla bilməz. İşçinin tibbi məlumatını silmək istədiyinizə
        əminsiniz?
      </ConfirmModal>
    </Stack>
  );
