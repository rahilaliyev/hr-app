...
import { useDeleteEmployeeWorkPlace, useGetEmployeeWorkPlaces } from 'src/api';
...
const WorkPlaces = () => {
  ...
  const { data = [] as ICategory[], isLoading } = useGetEmployeeWorkPlaces();
  const { mutate, isPending } = useDeleteEmployeeWorkPlace();
  ...
  return (
    <Stack width="100%" height="100%">
      ...
      >
        Bu əməliyyat daimidir və geri qaytarıla bilməz. İş yeri barədə məlumatı silmək istədiyinizə əminsiniz?
      </ConfirmModal>
    </Stack>
  );
};
