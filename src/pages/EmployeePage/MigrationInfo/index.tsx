...
import { useDeleteEmployeeMigrationInfo, useGetEmployeeMigrationInfo } from 'src/api';
...
const MigrationInfo = () => {
  ...
  const { data = [] as IMigrationInfo[], isLoading } = useGetEmployeeMigrationInfo();
  const { mutate, isPending } = useDeleteEmployeeMigrationInfo();
  ...
  return (
    <Stack width="100%" height="100%">
      ...
      >
        Bu əməliyyat daimidir və geri qaytarıla bilməz. İşçinin miqrasiya məlumatını silmək istədiyinizə
        əminsiniz?
      </ConfirmModal>
    </Stack>
  );
